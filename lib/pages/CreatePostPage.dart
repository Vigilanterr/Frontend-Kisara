          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text('Gambar dipilih dari galeri', style: GoogleFonts.inter(fontSize: 13, color: AppTheme.textSecondary)),
                ),
                GestureDetector(
                  onTap: _removeImage,
                  child: Container(
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: _isLoading
            ...
            : Text('Terbitkan Artikel', style: GoogleFonts.inter(fontSize: 16)),
      ),
    );
  }
}
